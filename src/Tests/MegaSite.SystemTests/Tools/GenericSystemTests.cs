...
using MegaSite.Site.Areas.Admin.Controllers;
    ...
    public class GenericSystemTests
    {
        ...
        public void AccessAllAdminPages()
        {
            ...
            var classes = typeof(BasicController).Assembly
                .GetTypes()
                .Where(type => type.IsSubclassOf(typeof(BaseController)) && type.Namespace.StartsWith("MegaSite.Site.Areas.Admin.Controllers"))
